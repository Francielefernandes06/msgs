...
Código para enviar várias Mensagens para seus amigos ou grupos do WhatsApp

## Utilização

Copie todo o conteúdo do arquivo msgs.js

Adicione as mensagens que deseja enviar, quebrando linhas.

No WhatsApp Web abra o console do Browser

``Botao direito do mouse -> Inspecionar -> Console -> cole o código -> aperte Enter``
